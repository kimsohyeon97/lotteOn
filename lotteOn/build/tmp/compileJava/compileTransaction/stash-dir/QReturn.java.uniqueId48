...
public class QReturn extends EntityPathBase<Return> {
    ...
    public final kr.co.lotteon.entity.order.QOrderItem orderItem;
    ...
    public QReturn(Class<? extends Return> type, PathMetadata metadata, PathInits inits) {
        ...
        this.orderItem = inits.isInitialized("orderItem") ? new kr.co.lotteon.entity.order.QOrderItem(forProperty("orderItem"), inits.get("orderItem")) : null;
